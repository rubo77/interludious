# Play Store Listing - Interludious

## App Information
- **App Name**: Interludious
- **Package Name**: de.z11.interludious
- **Version**: 1.0

## Short Description (80 characters max)
Interludious - Classic space action game with modern graphics
...
- **Internet**: For potential online features (optional)

### Privacy Policy

Interludious is a local game that does not collect any personal data. All game data (high scores, level progress) is stored locally on your device.
